...
@section('content')
    ...
    <div class="container-fluid pb-5 blog-inn news-home position-relative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    @endphp
                    <div class="navigation-detals d-flex flex-wrap flex-column flex-lg-row justify-content-start justify-content-lg-between align-items-start align-items-lg-center mb-4 pb-2 border-bottom">
                        ...
                        <ul class="d-flex flex-row justify-content-start align-items-center mt-4 mt-lg-0 gap-3 gap-lg-4 mb-0 list-unstyled">
                            <li class="nav-item nav-blog-mob">
                            ...
                            <li class="nav-item nav-blog-mob">
                                <a href="#" class="nav-link montserrat-medium text-center font-15 text-primary">{{substr(strip_tags($blogInner->title), 0, 23)}}...</a>
                            </li>
                        ...
                        <article>                            
                            ...
                            <div class="mb-3 d-flex justify-content-between align-items-center gap-1 flex-wrap">
                                <div class="d-flex align-items-center">
                                    <span class="badge bg-danger rounded-0 montserrat-semiBold font-12 text-uppercase py-2 px-2 px-lg-3 me-2">{{$blogInner->category->title}}</span>
                                    <p class="text-color mb-0 montserrat-regular font-15 dataFormatada">
                                ...
                                <div class="position-relative d-flex justify-content-center align-items-end flex-column">
                                    <button id="shareBtn" class="montserrat-semiBold font-14 bg-light px-2 px-lg-3 d-flex justify-content-around align-items-center btn text-muted">
                                        <div class="d-none d-lg-block">
                                            Compartilhar
                                        </div>

                                        <svg class="ms-0 ms-lg-2" width="18" height="20" viewBox="0 0 24 26" fill="none" xmlns="http://www.w3.org/2000/svg">
